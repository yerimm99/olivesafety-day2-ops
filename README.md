...
| 로그 수집 | 별도 구조 부족 | Loki, Alloy 기반 로그 수집 구조 |
...
Loki와 Alloy를 이용해 Kubernetes 로그 수집 구조를 구성했습니다.
...
특히 Secret 관리, IRSA 권한 분리, GitOps 배포, 모니터링, 로그 수집, 장애 알림, 운영 점검 스크립트, Atlantis 기반 Terraform PR 자동화를 단계적으로 적용했습니다.
