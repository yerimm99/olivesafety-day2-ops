...
| 모니터링 | 기본 지표 확인 중심 | Prometheus, Grafana, Alertmanager |
| 로그 수집 | Loki + Promtail 기반 로그 수집 구조 | Loki + Alloy 기반 로그 수집 구조로 재정리 및 운영 Runbook 문서화 |
...
Prometheus, Grafana, Alertmanager를 구성하여 EKS와 애플리케이션 메트릭을 확인할 수 있도록 했습니다.
...
특히 Secret 관리, IRSA 권한 분리, GitOps 배포, 모니터링, 기존 로그 수집 구조의 운영 관점 재정리, 장애 알림, 운영 점검 스크립트, Atlantis 기반 Terraform PR 자동화를 단계적으로 적용했습니다.
